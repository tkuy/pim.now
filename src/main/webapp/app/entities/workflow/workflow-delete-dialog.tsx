...
import {deleteEntity, getEntity} from './workflow.reducer';
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="pimnowApp.workflow.delete.question">
          <Translate contentKey="pimnowApp.workflow.delete.question" interpolate={{ id: workflowEntity.id }}>
