...
import fr.fastmarketeam.pimnow.repository.search.CustomerSearchRepositoryMockConfiguration;
...
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_ID_F = "IdF";
    private static final String UPDATED_ID_F = "IdF";
     ...
     *
     * @see CustomerSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final CustomerResource customerResource = new CustomerResource(customerRepository, mockCustomerSearchRepository, mockCustomerService, fileUploadService, userExtraRepository, userRepository);
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getIdF()).isEqualTo(DEFAULT_ID_F);
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getIdF()).isEqualTo(UPDATED_ID_F);
