...
import fr.fastmarketeam.pimnow.domain.Authority;
...
import fr.fastmarketeam.pimnow.web.rest.vm.ManagedUserVM;
...
public class UserResourceIT {
     ...
     *
     * @see fr.fastmarketeam.pimnow.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userService, userExtraService, userExtraRepository,  userRepository, mailService, mockUserSearchRepository, userMapper, userCustomerUtil);
